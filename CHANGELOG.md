...
[compare changes](https://github.com/ruan-cat/eams-component-lib/compare/@eams-monorepo/vue-element-cui-nuxt@4.0.0...v2.0.2)

## v2.0.1

[compare changes](https://github.com/ruan-cat/eams-component-lib/compare/@eams-monorepo/vue-element-cui-nuxt@4.0.0...v2.0.1)
...
## @eams-monorepo/vue-element-cui@4.0.0 (2026-08-31)

[compare changes](https://github.com/ruan-cat/eams-component-lib/compare/@eams-monorepo/vue-element-cui@3.0.0...@eams-monorepo/vue-element-cui@4.0.0)
...
- **cui-dialog:** 为 el-dialog 显式设置 append-to-body，修复遮罩层失效 ([c86237c](https://github.com/ruan-cat/eams-component-lib/commit/c86237c))
  ...
  Element Plus 2.13.x 中 appendToBody 默认为 false，导致 Teleport 被禁用，
  overlay 渲染在组件内部并被 isolation:isolate 堆叠上下文困住。
  Co-authored-by: Cursor <199161495+cursoragent@users.noreply.github.com>
  Co-authored-by: Claude <noreply@anthropic.com>
